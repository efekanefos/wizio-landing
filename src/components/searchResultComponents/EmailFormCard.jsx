...
const EmailFormCard = () => {
  return (
    ...
    >
      <div className="z-10 w-80 h-fit absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] p-3 bg-white rounded-[32px] shadow-lg flex flex-col justify-start items-center gap-5">
        ...
        <div className="w-full px-3 py-4 border-b border-gray-200 flex flex-col justify-start items-start gap-0.5 ">
          ...
          <textarea className="outline-none border border-gray-200 w-full mt-0.5 rounded-2xl p-2 text-xs font-light min-h-20 custom-resize" name="" id=""></textarea>
        </div>
