...
function TownhousesIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M13.5 6V9.75" stroke="#171717" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M12.75 12.75H11.25C10.8375 12.75 10.5 13.0875 10.5 13.5V16.5H13.5V13.5C13.5 13.0875 13.1625 12.75 12.75 12.75Z" stroke="#171717" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M4.5 9.75V12.75" stroke="#171717" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
      <path
