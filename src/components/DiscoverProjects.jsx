  ...
  return (
    <div>
      <div
        ...
        className="absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] flex flex-col w-full max-w-[896px] max-h-[384px] overflow-y-auto py-12 px-12 bg-white shadow-2xl rounded-3xl z-10"
      >
