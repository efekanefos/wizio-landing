...
function LandingPage({ theme, setTheme }) {
  ...
  return (
    <div className="overflow-y-hidden max-h-screen font-inter">
      <nav className={`flex justify-between ${showUpperOptions ? `items-start` : `items-center`} py-3 px-9 z-10 relative bg-white font-inter max-lg:px-5 max-md:px-5 max-sm:gap-4`}>
        {/* Logo Side */}
